...
//a-all=aaaaaaaaaaaa,a-a=aaaaaaaaaaaa,a-b=aaaaaaaaaaaa,a-c=aaaaaaaaaaaa,a-d=aaaaaaaaaaaa
//t-all=aaaaaaaaaaaa,t-a=aaaaaaaaaaaa,t-b=aaaaaaaaaaaa,t-c=aaaaaaaaaaaa,t-d=aaaaaaaaaaaa
...
void generate_next_state(char* buffer, int buffer_size)
{
    ...
    snprintf(buffer, buffer_size, "A_ALL=%s;A_A=%s;A_B=%s;A_C=%s;A_D=%s;"
