...
UCHAR CH9120_LOCAL_IP[4] = {192, 168, 201, 206};
UCHAR CH9120_GATEWAY[4] = {192, 168, 201, 1};
UCHAR CH9120_SUBNET_MASK[4] = {255, 255, 255, 0};
UCHAR CH9120_REMOTE_IP[4] = {192, 168, 201, 101};
UWORD CH9120_LOCAL_PORT = 1001;
UWORD CH9120_REMOTE_PORT = 2001;
